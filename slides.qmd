...
1. Jupyter natively approaches this as storing the source code, output file, and optionally cache the resulting computation in a single document (`.ipynb` which is JSON)
...
- Frozen computation stored separately by directory and file as `.json`, allows for permanately saving and re-use of computational outputs.
